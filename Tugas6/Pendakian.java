...
public class Pendakian {
    public static void main(String[] args) {
        ...
        System.out.print("Masukan tenaga : ");
        ...
        for (int i = 0; i < track.length(); i++) {
            ...
            if (movement == 'L' && colom > 0) {
                colom--;
            } else if (movement == 'R' && colom < mapSemeru[0].length - 1) {
                colom++;
            } else if (movement == 'U' && row > 0) {
                row--;
            } else if (movement == 'D' && row < mapSemeru.length - 1) {
                row++;
            } else if (movement == 'S') {

                String post = mapSemeru[row][colom];
                if (post.equals("P2") ||
                        post.equals("P3") ||
                        post.equals("P4") ||
                        post.equals("P5") ||
            ...
            if (energy <= 0) {
                ...
                return;
            } else if (mapSemeru[row][colom].equals("X")) {
                System.out.println("ANDA SALAH JALUR!! ANDA AKAN MASUK KE JURANG");
                return;
            } else if (mapSemeru[row][colom].equals("P")) {
                System.out.println(
